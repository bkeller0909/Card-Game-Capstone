    ...
    public override void Act(PlayerManager player, PlayerManager enemy)
    {
        ...
        else
        {
            ...
            if (player == GameManager.Instance.player1 && GameManager.Instance.particleWait[GameManager.Instance.spellIndex] && !GameManager.Instance.particleP1Done)
            {
                ...
                {
                    ParticleManger.Instance.StartParticle(SpellNames.RightingBolt, GameManager.Instance.spellsBeingCast[GameManager.Instance.spellIndex, playerIndex].whatFinger, player, 1);
                ...
                {
                    ParticleManger.Instance.StartParticle(SpellNames.RightingBolt, GameManager.Instance.spellsBeingCast[GameManager.Instance.spellIndex, playerIndex].whatFinger, player, 2);
                    RumbleManager.Instance.PulseRumble(0.2f, 0.2f, 0.2f, 1.5f, player.gamepad);
                    RumbleManager.Instance.PulseRumble(0.5f, 1f, 0.2f, 1.5f, enemy.gamepad);
                    enemy.cameraHandler.CameraShake(0.03f, 1.5f);
                }
                ...
                {
                    ParticleManger.Instance.StartParticle(SpellNames.RightingBolt, GameManager.Instance.spellsBeingCast[GameManager.Instance.spellIndex, playerIndex].whatFinger, player, 3);
                    RumbleManager.Instance.PulseRumble(0.2f, 0.2f, 0.2f, 1.5f, player.gamepad);
                    RumbleManager.Instance.PulseRumble(0.5f, 1f, 0.2f, 1.5f, enemy.gamepad);
                    enemy.cameraHandler.CameraShake(0.03f, 1.5f);
                }
